      ...
      <div className='bookmark'>
        <a href={url}>
          <img
            ...
            src={'blob:chrome-extension://' + favicon}
            alt={`${linkName} link`}
          />
        </a>
        <a href={url}>
          <p>
            {linkName.length > 10 ? linkName.slice(0, 7) + '...' : linkName}
          </p>
        </a>
        <button
  ...
  return (
    <div className='bookmark active'>
      ...
      <div className='button_wrapper'>
        <button
          className='bookmark__delete4ever-button'
          onClick={() => manageDelete(tabIdx, shortcutIdx)}
        >
          Delete
        </button>

        <button
          className='bookmark__cancel-button'
